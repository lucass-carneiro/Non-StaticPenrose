...
auto grlensing::SKS::dllgSKS_00_dx(double t, double x, double y, double z) const noexcept
  ...
  const double v14{dX_dx(2, t, x, y, z)};
  const double v15{dX_dx(1, t, x, y, z)};
  const double v16{dZ_dx(2, t, x, y, z)};
  const double v17{dZ_dx(1, t, x, y, z)};
  const double v18{dY_dx(2, t, x, y, z)};
  const double v19{dY_dx(1, t, x, y, z)};
