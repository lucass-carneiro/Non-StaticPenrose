...
auto grlensing::SKS::dllgSKS_00_dz(double t, double x, double y, double z) const noexcept
    -> double {
  ...
  const double v14{dX_dz(2, t, x, y, z)};
  const double v15{dX_dz(1, t, x, y, z)};
  const double v16{dY_dz(2, t, x, y, z)};
  const double v17{dY_dz(1, t, x, y, z)};
  const double v18{dZ_dz(2, t, x, y, z)};
  const double v19{dZ_dz(1, t, x, y, z)};
