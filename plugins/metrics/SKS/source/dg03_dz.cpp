...
auto grlensing::SKS::dllgSKS_03_dz(double t, double x, double y, double z) const noexcept
    -> double {
  ...
  const double v10{dX_dz(2, t, x, y, z)};
  const double v11{dX_dz(1, t, x, y, z)};
  const double v12{dY_dz(2, t, x, y, z)};
  const double v13{dY_dz(1, t, x, y, z)};
  const double v14{dZ_dz(2, t, x, y, z)};
  const double v15{dZ_dz(1, t, x, y, z)};
