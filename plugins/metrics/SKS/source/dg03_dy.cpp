...
auto grlensing::SKS::dllgSKS_03_dy(double t, double x, double y, double z) const noexcept
    -> double {
  ...
  const double v10{dX_dy(2, t, x, y, z)};
  const double v11{dX_dy(1, t, x, y, z)};
  const double v12{dY_dy(2, t, x, y, z)};
  const double v13{dY_dy(1, t, x, y, z)};
  const double v14{dZ_dy(2, t, x, y, z)};
  const double v15{dZ_dy(1, t, x, y, z)};
  ...
  const double v36{dH_KS_dZ(M2, a2, v2, v1, v0)};
  const double v37{dH_KS_dZ(M1, a1, v5, v4, v3)};
  const double v38{sqrt(v30)};
  const double v39{sqrt(v31)};

  return (v14 * v22 * v24 * v38 + v12 * v22 * v26 * v38 + v10 * v22 * v28 * v38
          + v10 * v16 * v32 * v38 + v12 * v16 * v34 * v38 + v14 * v16 * v36 * v38
          + v15 * v23 * v25 * v39 + v13 * v23 * v27 * v39 + v11 * v23 * v29 * v39
          + v11 * v19 * v33 * v39 + v13 * v19 * v35 * v39 + v15 * v19 * v37 * v39
          - v14 * v17 * v22 * v24 * v38 * v6 - v12 * v17 * v22 * v26 * v38 * v6
          - v10 * v17 * v22 * v28 * v38 * v6 - v10 * v16 * v17 * v32 * v38 * v6
          - v12 * v16 * v17 * v34 * v38 * v6 - v14 * v16 * v17 * v36 * v38 * v6
          - v15 * v20 * v23 * v25 * v39 * v7 - v13 * v20 * v23 * v27 * v39 * v7
          - v11 * v20 * v23 * v29 * v39 * v7 - v11 * v19 * v20 * v33 * v39 * v7
          - v13 * v19 * v20 * v35 * v39 * v7 - v15 * v19 * v20 * v37 * v39 * v7
          - v15 * v21 * v23 * v25 * v39 * v8 - v13 * v21 * v23 * v27 * v39 * v8
          - v11 * v21 * v23 * v29 * v39 * v8 - v11 * v19 * v21 * v33 * v39 * v8
          - v13 * v19 * v21 * v35 * v39 * v8 - v15 * v19 * v21 * v37 * v39 * v8
          - v14 * v18 * v22 * v24 * v38 * v9 - v12 * v18 * v22 * v26 * v38 * v9
          - v10 * v18 * v22 * v28 * v38 * v9 - v10 * v16 * v18 * v32 * v38 * v9
          - v12 * v16 * v18 * v34 * v38 * v9 - v14 * v16 * v18 * v36 * v38 * v9
          - v15 * v19 * v23 * v39 * v8 * dl1_KS_dZ(a1, v5, v4, v3)
          - v14 * v16 * v22 * v38 * v9 * dl1_KS_dZ(a2, v2, v1, v0)
          - v15 * v19 * v23 * v39 * v7 * dl2_KS_dZ(a1, v5, v4, v3)
          - v14 * v16 * v22 * v38 * v6 * dl2_KS_dZ(a2, v2, v1, v0)
